  ...
  <body>
    <div id="info" class="box_section" style="width: 600px; margin-top: 200px;">
      ...
      <div class="p-grid">
        ...
        <button class="button p-grid-col5" onclick="location.href='${pageContext.request.contextPath}/payment.do';" style="background-color: #e8f3ff; color: #1b64da">결제 재시도</button>
      </div>
    </div>
  </body>
</html>